...
<?php echo $this->Form->create('Event'); ?>
	...
	<?php
		...
		/*for ($i=0; $i < count($event['Artist']); $i++) { 
			echo $this->Form->input('Artist.'.$i.'.name');
		}*/
...
<div class="actions">
	...
	<ul>
		...
		<li><?php //echo $this->Form->postLink(__('イベントの削除'), array('action' => 'delete', $this->Form->value('Event.id')), null, __('『%s』を削除しますか？', $this->Form->value('Event.title'))); 
				  echo $this->Html->link(__('イベントの削除申請'), array('action' => 'delete', $this->Form->value('Event.id'))); ?></li>
